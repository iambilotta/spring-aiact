...
# Running it on every commit AND after every tree-mutating integration op (post-merge /
# post-rewrite) is what makes the committed catalog unable to drift (ADR sw-scm-007).
set -euo pipefail
